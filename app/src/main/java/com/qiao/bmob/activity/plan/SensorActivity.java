...
import com.qiao.bmob.dialog.CommonDialog;
...
public class SensorActivity extends BaseActivity {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        sensor_time_tv = findViewById(R.id.sensor_time_tv);
        sensor_count_tv = findViewById(R.id.sensor_count_tv);
        sensor_start_iv = findViewById(R.id.sensor_start_iv);
        sensor_stop_iv = findViewById(R.id.sensor_stop_iv);

        sensor_sport1_tv = findViewById(R.id.sensor_sport1_tv);
        sensor_sport2_tv = findViewById(R.id.sensor_sport2_tv);
        sensor_sport3_tv = findViewById(R.id.sensor_sport3_tv);
        sensor_sport4_tv = findViewById(R.id.sensor_sport4_tv);
