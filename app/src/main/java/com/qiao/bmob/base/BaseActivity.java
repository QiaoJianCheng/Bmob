...
import com.qiao.bmob.event.FinishEvent;
...
import com.qiao.bmob.view.DragParentLayout;
...
public abstract class BaseActivity extends AppCompatActivity implements LifecycleProvider<ActivityEvent> {
    ...
    private void initCommonView() {
        ...
        if (common_title_text_tv == null) {
            common_title_text_tv = findViewById(R.id.common_title_text_tv);
        }
        if (common_title_button_iv == null) {
            common_title_button_iv = findViewById(R.id.common_title_button_iv);
        }
