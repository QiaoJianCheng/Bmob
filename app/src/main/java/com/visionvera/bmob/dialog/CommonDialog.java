...
public class CommonDialog {
    ...
    private View getContentView() {
        ...
        common_dialog_msg_tv = (TextView) view.findViewById(R.id.common_dialog_msg_tv);
        common_dialog_confirm_tv = (TextView) view.findViewById(R.id.common_dialog_confirm_tv);
        common_dialog_cancel_tv = (TextView) view.findViewById(R.id.common_dialog_cancel_tv);
