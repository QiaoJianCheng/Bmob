...
public class UserAdapter extends BaseRecyclerAdapter<UsersBean.UserBean> {
    ...
    private class UserHolder extends BaseViewHolder {
        ...
        public UserHolder(View itemView) {
            super(itemView);
            item_user_avatar_sdv = itemView.findViewById(R.id.item_user_avatar_sdv);
            item_user_name_tv = itemView.findViewById(R.id.item_user_name_tv);
            item_user_gender_iv = itemView.findViewById(R.id.item_user_gender_iv);
            item_user_signature_tv = itemView.findViewById(R.id.item_user_signature_tv);
            item_user_level_tv = itemView.findViewById(R.id.item_user_level_tv);
