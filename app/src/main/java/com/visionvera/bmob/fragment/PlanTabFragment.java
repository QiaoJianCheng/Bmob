...
public class PlanTabFragment extends BaseFragment {
    ...
    protected void initViews(View view, Bundle savedInstanceState) {
        ...
        plan_color_filter_tv = (TextView) view.findViewById(R.id.plan_color_filter_tv);
        plan_camera_tv = (TextView) view.findViewById(R.id.plan_camera_tv);
        plan_codec_tv = (TextView) view.findViewById(R.id.plan_codec_tv);
        plan_kotlin_tv = (TextView) view.findViewById(R.id.plan_kotlin_tv);
