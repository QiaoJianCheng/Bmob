...
import com.visionvera.veraclient.codec.video.opengl.GLFrameRenderer;
import com.visionvera.veraclient.codec.video.opengl.GLFrameSurface;
import com.visionvera.veraclient.codec.video.opengl.ISimplePlayer;
import com.visionvera.veraclient.util.LogUtil;

public class YUVView extends GLFrameSurface implements SurfaceHolder.Callback, ISimplePlayer {
    ...
    public void Play(YUVFrame vdFrame) {
        if (OpenGLMode) {
    ...
    protected void drawImg(final Bitmap bmp) {
        ...
        if (canvas == null) {
            this.post(new Runnable() {
                public void run() {
                    YUVView.this.setBackground(new BitmapDrawable(bmp));
                }
            });
        } else {
            try {
