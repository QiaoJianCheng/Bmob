...
public class HomeActivity2 extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        home_tab_apps_rl = (RelativeLayout) findViewById(R.id.home_tab_apps_rl);
        home_tab_apps_0_iv = (ImageView) findViewById(R.id.home_tab_apps_0_iv);
        home_tab_apps_1_iv = (ImageView) findViewById(R.id.home_tab_apps_1_iv);
        home_tab_apps_tv = (TextView) findViewById(R.id.home_tab_apps_tv);
        home_tab_users_rl = (RelativeLayout) findViewById(R.id.home_tab_users_rl);
        home_tab_users_0_iv = (ImageView) findViewById(R.id.home_tab_users_0_iv);
        home_tab_users_1_iv = (ImageView) findViewById(R.id.home_tab_users_1_iv);
        home_tab_users_tv = (TextView) findViewById(R.id.home_tab_users_tv);
        home_tab_plan_rl = (RelativeLayout) findViewById(R.id.home_tab_plan_rl);
        home_tab_plan_0_iv = (ImageView) findViewById(R.id.home_tab_plan_0_iv);
        home_tab_plan_1_iv = (ImageView) findViewById(R.id.home_tab_plan_1_iv);
        home_tab_plan_tv = (TextView) findViewById(R.id.home_tab_plan_tv);
