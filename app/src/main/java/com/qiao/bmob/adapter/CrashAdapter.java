...
public class CrashAdapter extends BaseRecyclerAdapter<CrashesBean.CrashBean> {
    ...
    private class CrashHolder extends BaseViewHolder {
        ...
        public CrashHolder(View itemView) {
            super(itemView);
            item_crash_model_tv = itemView.findViewById(R.id.item_crash_model_tv);
            item_crash_api_tv = itemView.findViewById(R.id.item_crash_api_tv);
            item_crash_version_tv = itemView.findViewById(R.id.item_crash_version_tv);
            item_crash_time_tv = itemView.findViewById(R.id.item_crash_time_tv);
        }
