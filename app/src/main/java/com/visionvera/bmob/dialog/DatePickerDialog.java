...
public class DatePickerDialog {
    ...
    private View getContentView() {
        ...
        this.dialog_picker_date = (DatePicker) view.findViewById(R.id.dialog_picker_date);
        this.dialog_picker_date.setDescendantFocusability(DatePicker.FOCUS_BLOCK_DESCENDANTS);
        this.dialog_picker_confirm_tv = (TextView) view.findViewById(R.id.dialog_picker_confirm_tv);
        this.dialog_picker_cancel_tv = (TextView) view.findViewById(R.id.dialog_picker_cancel_tv);
